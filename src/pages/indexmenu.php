...
if (!$_SESSION["employee_id"]){ //check session
...
<div class="container-fuit title">
                <h2 class="logo">
                  <i class="fas fa-fish"></i>ระบบจัดการฟาร์มปลา</h2>
</div> 
    ...
    <nav class="active">
        <ul>
            ...
            <li class="sub-menu"><a href="#">เกี่ยวกับบุคคล</a>
                <ul>
                    <li><a href="customer-index.php">ข้อมูลลูกค้า</a></li>
                    <li><a href="employee-index.php">ข้อมูลพนักงาน</a></li>
                    <li><a href="supplier-index.php">ข้อมูลซัพพลายเออร์</a></li>
                </ul>
            </li>

            <li class="sub-menu"><a href="#">เกี่ยวกับอุปกรณ์</a>
                <ul>
                    <li><a href="equipment-index.php">ข้อมูลอุปกรณ์</a></li>
                    <!-- <li><a href="repairing_material-index.php">ข้อมูลการซ่อม</a></li> -->
                </ul>
            </li>

            <li class="sub-menu"><a href="#">เกี่ยวกับปลาต่อกระชัง</a>
                <ul>
                    <li><a href="fish-index.php">ข้อมูลปลาต่อกระชัง</a></li>
                    <li><a href="type_fish-index.php">ประเภทปลา</a></li>
                    <!-- <li><a href="stew_fish-index.php">กระชังปลา</a></li> -->
                    <li><a href="order_fish-index.php">การสั่งซื้อลูกปลา</a></li>
            ...
            <li class="sub-menu"><a href="#">เกี่ยวกับอาหาร</a>
                <ul>
                    <li><a href="food_data-index.php">ข้อมูลอาหาร</a></li>
                    <li><a href="give_food-index.php">การให้อาหาร</a></li>
                    <li><a href="order_food-index.php">การสั่งซื้ออาหาร</a></li>
            ...
            <li class="sub-menu"><a href="#">เกี่ยวกับยารักษาโรค</a>
                <ul>
                    <li><a href="Medicine_data-index.php">ข้อมูลยารักษาโรค</a></li>
                    <li><a href="give_Medicine-index.php">การให้ยารักษาโรค</a></li>
                    <li><a href="order_medicine-index.php">การสั่งซื้อยารักษาโรค</a></li>
            ...
            <li><a href="sales_fish-index.php">การขาย/การชำระ</a></li>

            <li><a href="delivery_show.php">การจัดส่ง</a>
            <!-- <li><a href="work-index.php">วันเข้างาน</a> -->
                <!-- <ul> -->
                    <!-- <li><a href="#">การใช้วัตถุดิบในการผลิต</a></li> -->
                    <!-- <li><a href="#">คำนวณตั้งราคาสินค้า</a></li> -->
                <!-- </ul> -->
            </li>

            <li><a href="salary-index.php">ค่าตอบแทน</a></li>

            <!-- <li><a href="#">คำนวณตั้งราคาสินค้า</a></li> -->

            <!-- <li class="sub-menu"><a href="#">การซ่อมสินค้า</a>
                <ul>
                    <li><a href="#">การใช้วัตถุดิบในการซ่อม</a></li>
                </ul>
            </li> -->
            ...
            <li>
            <a href="welcome.php"><i class="fas fa-user-alt"> &nbsp;<?php echo $_SESSION["firstname"] ?> </i></a> 
            </li>
            <li>
