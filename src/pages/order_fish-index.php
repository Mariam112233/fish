...
<?php 
    ...
    ORDER BY fish_order.fish_order_id DESC";
...
<div class="contact-section">
    <h4>ข้อมูลการสั่งซื้อลูกปลา /food order</h4>

    <form action="" method="get" enctype="multipart/form-data" class="form-inline mr-auto">
        <a href="order_fish-form.php" class="btn btn-success"><i class="fas fa-plus">สั่งซื้อลูกปลาเข้ากระชัง</i></a> &nbsp;
...
?>
        ...
        <tr>
           <th><?php echo $result['fish_order_id']; ?></th>
           <td><?php echo $result['fish_order_date']; ?></td>
           ...
           <!-- class="contact-form-btn" -->
                <a href="order_fish-report.php?fish_order_id=<?php echo $result['fish_order_id'];?>" class="btn btn-primary"><i class="fas fa-eye"></i></a>
                <a href="order_fish-edit.php?fish_order_id=<?php echo $result['fish_order_id'];?>" class="btn btn-warning"><i class="fas fa-pencil-alt"></i></a>
