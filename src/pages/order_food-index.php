...
<?php 
    ...
    ORDER BY food_order.food_order_id ASC";
...
<div class="contact-section">
    <h4>ข้อมูลการสั่งซื้ออาหารปลา /food order</h4>

    <form action="" method="get" enctype="multipart/form-data" class="form-inline mr-auto">
        <a href="order_food-form.php" class="btn btn-success"><i class="fas fa-plus"></i></a> &nbsp;
...
?>
        ...
        <tr>
           <th><?php echo $result['food_order_id']; ?></th>
           <td><?php echo $result['food_order_date']; ?></td>
           <td><?php echo $result['firstname']; ?> <?php echo $result['lastname']; ?></td>
           <td><?php echo $result['supplier_food_name']; ?></td>
           
           
           <td>
           <!-- class="contact-form-btn" -->
                <a href="order_food-report.php?food_order_id=<?php echo $result['food_order_id'];?>" class="btn btn-primary"><i class="fas fa-eye"></i></a>
                <a href="order_food-edit.php?food_order_id=<?php echo $result['food_order_id'];?>" class="btn btn-warning"><i class="fas fa-pencil-alt"></i></a>
